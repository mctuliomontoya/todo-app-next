...
export default function HistoryTrigger() {
  return (
    <React.Fragment>
      <button
        className="transition duration-500 ease-out h-12 w-12 mx-1 rounded-full bg-ui-base-200 flex items-center hover:bg-bone/20 justify-center"
        onClick={() =>
          (
